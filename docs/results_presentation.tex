...
\begin{center}
  \movie[width=0.82\textwidth, height=0.461\textwidth,
         poster, showcontrols]{%
    \includegraphics[width=0.82\textwidth]{grc_poster_frame.png}%
  }{grc_screen_record.mp4}\\[0.3em]
  \small\textbf{Click above to play}\enspace{\scriptsize(Adobe Acrobat Reader)}
  \quad\textbullet\quad
  \href{https://nusu-my.sharepoint.com/:v:/g/personal/manujayaugp_u_nus_edu/IgBL8WLq6Kg3T72oFts44raeAY2qRBnLZsHWS2kot5pOpYc}{%
    \textcolor{NUSorange}{\textbf{$\blacktriangleright$\enspace Watch full-screen on NUS OneDrive}}}\\[0.1em]
  {\scriptsize\textcolor{NUSgray}{(works in any browser — Edge, Chrome, phone)}}
\end{center}
\end{frame}
