...
\begin{columns}[T]
  \begin{column}{0.58\textwidth}
    \begin{center}
      % Video embedded in PDF — click to play in Adobe Acrobat Reader
      \includemedia[
        width=\linewidth,
        height=0.5625\linewidth,  % 16:9 aspect ratio
        activate=onclick,
        ...
        passcontext
      ]{\includegraphics[width=\linewidth]{grc_poster_frame.png}}{VPlayer.swf}
      \\[0.3em]
      {\scriptsize\textcolor{NUSgray}{Click video to play $\cdot$ H.264 MP4 embedded $\cdot$ Adobe Acrobat Reader}}
    \end{center}
  \end{column}
