...
\begin{columns}[T]
  \begin{column}{0.55\textwidth}
    \begin{center}
      \qrcode[height=3.2cm]{https://nusu-my.sharepoint.com/:f:/g/personal/manujayaugp_u_nus_edu/IgBL8WLq6Kg3T72oFts44raeAY2qRBnLZsHWS2kot5pOpYc}\\[0.4em]
      {\small\textbf{Scan QR code to watch the demo video}}\\[0.3em]
      {\footnotesize\textcolor{NUSgray}{or click: }}%
      \href{https://nusu-my.sharepoint.com/:f:/g/personal/manujayaugp_u_nus_edu/IgBL8WLq6Kg3T72oFts44raeAY2qRBnLZsHWS2kot5pOpYc}{\textcolor{NUSorange}{\textbf{NUS OneDrive — grc\_screen\_record.mkv}}}
    \end{center}
  \end{column}
  \begin{column}{0.42\textwidth}
    \vspace{0.5em}
