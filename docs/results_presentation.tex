...
\begin{columns}[T]
  \begin{column}{0.55\textwidth}
    \begin{center}
      \movie[externalviewer,poster,borderwidth=1pt,label=grc_demo]{%
        \includegraphics[width=\textwidth]{grc_demo_thumb.png}%
      }{../screen records/grc_screen_record.mkv}\\[0.3em]
      {\footnotesize\textit{Click image to play $\cdot$ \texttt{grc\_screen\_record.mkv}}}
    \end{center}
  \end{column}
  \begin{column}{0.42\textwidth}
    \vspace{0.5em}
