...
\begin{columns}[T]
  \begin{column}{0.55\textwidth}
    \begin{center}
      \movie[width=\textwidth,height=0.56\textwidth,poster,borderwidth=1pt,label=grc_demo]{%
        \includegraphics[width=\textwidth]{grc_demo_thumb.png}%
      }{../screen records/grc_screen_record.mp4}\\[0.3em]
      {\footnotesize\textit{Click to play inline $\cdot$ \texttt{grc\_screen\_record.mp4}}}
    \end{center}
  \end{column}
  \begin{column}{0.42\textwidth}
    \vspace{0.5em}
